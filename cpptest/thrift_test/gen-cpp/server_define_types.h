 ...
 *  @generated
 */
#ifndef server_define_TYPES_H
#define server_define_TYPES_H
...
typedef struct _CommunicateMessage__isset {
  _CommunicateMessage__isset() : timestamp(false), categories(false), myMap(false), newMap(false) {}
  bool timestamp :1;
  bool categories :1;
  bool myMap :1;
  bool newMap :1;
...
class CommunicateMessage {
 public:
  ...
  std::map<int64_t, std::string>  newMap;
  ...
  void __set_newMap(const std::map<int64_t, std::string> & val);
  ...
  bool operator == (const CommunicateMessage & rhs) const
  {
    ...
    if (__isset.myMap != rhs.__isset.myMap)
      ...
      return false;
    if (__isset.newMap != rhs.__isset.newMap)
      return false;
    else if (__isset.newMap && !(newMap == rhs.newMap))
      return false;
    return true;
  }
  bool operator != (const CommunicateMessage &rhs) const {
